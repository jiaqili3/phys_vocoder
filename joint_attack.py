...
# the first item in `model` is combined-model
thres = model[0].threshold
model[0] = CombinedModel(model[0], config.phys_vocoder_model)
model[0].eval()
model[0].threshold = thres
